    ...
    $(document).ready(function() {
        ...
        function preencherDadosAtendimento(data) {
            ...
            if (data.length > 0) {
                ...
                var headerRow = '<thead class="thead-dark"><tr><th>Data de referência</th><th>Total do período</th>';
        ...
        $('form').on('submit', function(event) {
            ...
            var dataInicioDate = new Date(dataInicio);
            ...
            var frase = veiculo + ' - ' + nomeMesInicio + ' de ' + anoInicio + ' a ' + nomeMesFim + ' de ' + anoFim + '.';

            $('#nome_veiculo_selecionado').html('<span>'+ frase + '</sapn>');
